# My take on the hex bot
Service workers crawl and scrape dribble to find similar images from hex codes using ruby on rails, and nokogiri to scrape.
[Live version Here](https://similar-color-image.herokuapp.com)
